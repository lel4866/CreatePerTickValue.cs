...
namespace CreatePerTickValue
{
    ...
    class Program
    {
        ...
        static readonly DateTime preSessionBegTime = Convert.ToDateTime("08:00:00");
        static readonly DateTime sessionEndTime = Convert.ToDateTime("16:00:00");
        static readonly DateTime sessionBegTime = Convert.ToDateTime("09:30:00");
        static readonly TimeSpan sessionStartTS = new TimeSpan(9, 30, 0);
        static readonly DateTime firstDate = Convert.ToDateTime("1/1/2000");
        static readonly DateTime checkDate = Convert.ToDateTime("9/18/2020");
